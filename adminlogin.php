            ...
            <section class="sign-in">
                <div class="container1">
                    <div class="signin-content">
                        ...
                        <div class="signin-form" style="margin-left: 210px;">
                            <h2 class="form-title" style="margin-left: 150px;">Login</h2>
                            <form method="post" class="register-form" id="login-form" action="admindb.php">
                                ...
                                <div class="form-group form-button">
                                    <input type="submit" style="margin-left: 150px;" name="signin" id="signin" class="form-submit" value="Log in"/>
                                </div>
                            </form>                    
                        </div>
                    </div>
