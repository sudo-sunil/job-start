...
require "connect.php";
$sql = "SELECT employee_id,company,job_type,location,title,employer_id FROM jobdet,applyjob WHERE applyjob.job_id=jobdet.job_id";
...
if ($result->num_rows > 0)
  {
        ...
        <th style='text-align: center' onclick='sortTable(2)'>Job Type</th>
        <th style='text-align: center' onclick='sortTable(3)'>Job Title</th>
		<th style='text-align: center' onclick='sortTable(4)'>Employer Name</th>
		
        <th style='text-align: center' onclick='sortTable(5)'>Location</th>
        </tr>";
        ...
        { 
          ...
          <td>' . $job_type. '</td><td>' . $title. '</td>  <td>' . $employer_id. '</td> <td>' . $location. '</td>
          </tr>';
        }
