					...
					<div class="w3-container" style="">
					  ...
					  <div class="w3-card-4" style="width:50%;margin:auto;">
						...
						<div class="w3-container">
						  <hr>
						  <h4>'.$title.'</h4>
						  <h5>Job Type : '.$job_type.' &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Location : '.$location.'</h5>
						  <p>'.$description.'</p><br>
						</div>
						
						
						<form method="POST" action="applydb.php">
						<input type="hidden" name="job_id" value="'.$job_id.'">
						<button type="submit" class="w3-button w3-block bg-primary text-white">Apply</button>
						</form>
